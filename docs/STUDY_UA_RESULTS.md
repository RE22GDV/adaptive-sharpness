...
**Але пороги важать, і важать сильно** — через те, чи спрацьовує фіксація
вчасно на **кожному** записі. Розділення сітки за цією ознакою пояснює весь
розкид 0.591…0.971:

| Спрацювала на | Наборів | Спірмен |
| --- | --- | --- |
| усіх 8 записах | 6 | 0.915…0.971 |
| 7 із 8 | 6 | 0.757…0.968 |
| 6 із 8 | 6 | 0.592…0.654 |
| 4 із 8 | 9 | 0.591…0.592 |

`min_samples = 480` не встигає спрацювати більш ніж на половині записів —
записи умов мають лише 560–620 кадрів. `patience = 240` блокує так само. А при
межовому спрацюванні починає важити й поріг стабільності: 0.02 дає 0.757–0.783
там, де 0.05 і 0.10 дають 0.965–0.968.

Тому правильне формулювання таке: **критичний механізм, а пороги керують його
своєчасністю — і невчасна фіксація майже так само погана, як її відсутність.**
Поточні 240/120/0.05 спрацьовують на 7 записах із 8.
