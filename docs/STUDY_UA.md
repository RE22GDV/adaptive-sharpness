...
>
> Опис **принципу роботи**, схеми, історія змін і програма досліджень — у
> [STUDY_UA_REPORT.md](STUDY_UA_REPORT.md). **Результати всіх чотирнадцяти
> досліджень Д07–Д20** — у [STUDY_UA_RESULTS.md](STUDY_UA_RESULTS.md).
...
> **Закрито програмою досліджень** ([усі результати](STUDY_UA_RESULTS.md)).
>
> Різниця **не розрізнювана**: блоковий bootstrap із довжиною блока за
> автокореляцією дає 95% інтервал **[−0.046, +0.029]** при оцінці −0.005 —
> приблизно вдевʼятеро ширший. Таблиця за записами вище лишається описом.
>
> Ваги прочитано покадрово, і вони **майже не рухаються**: розмах за весь
> запис 0.01–0.05 при середніх 0.04–0.24. Розрізняти майже нічого. Механізм
> із насиченими чинниками підтверджено лише частково — по восьми записах
> звʼязок ρ = −0.41, і запис із 66 % насичення виграє найбільше.
